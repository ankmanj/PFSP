...
from pfsp_gui.node_editor.node_graphics_socket import QDMGraphicsSocket
from pfsp_gui.node_editor.node_graphics_edge import QDMGraphicsEdge
from pfsp_gui.node_editor.node_edge import Edge, EDGE_TYPE_BEZIER
from pfsp_gui.node_editor.node_graphics_cutline import QDMCutLine
        ...
        try:
            if type(item) is QDMGraphicsSocket:
                if item.socket != self.drag_start_socket:
                    ...
                    if DEBUG: print('View::edgeDrag ~  created new edge:', new_edge, 'connecting', new_edge.start_socket, '<-->', new_edge.end_socket)
